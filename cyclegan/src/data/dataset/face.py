...
class FaceDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.imgA_paths = glob.glob(f"{self.dataset_dir}/face_photo/*.jpg")
        self.imgB_paths = glob.glob(f"{self.dataset_dir}/face_cartoon/*/*.jpg")
...
if __name__ == "__main__":
    dataset = FaceDataset(data_dir='data')
    print(len(dataset))
